/*! For license information please see main.400b80dd.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'a94'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '162'),
                  routes: [
                    {
                    ...
                    },
                    {
                      ...
                      component: b('/docs/destinations/convertkit', '968'),
                      exact: !0,
                      sidebar: 'integrations',
                    },
                    {

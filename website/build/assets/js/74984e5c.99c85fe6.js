/*! For license information please see 74984e5c.99c85fe6.js.LICENSE.txt */
'use strict';
    ...
    9806: (e, t, n) => {
      ...
      const r = {id: 'redshift', title: 'Redshift', description: 'redshift'},
        ...
        a = [
          ...
          {
            value: 'Step 2: Set up the destination connector in HeroPixel',
            id: 'step-2-set-up-the-destination-connector-in-heropixel',
            level: 2,
          },
          ...
          children: [
            ...
            (0, s.jsxs)(t.p, {
              children: [
                ...
                ' and a "Raw Data" schema that HeroPixeluses to improve ELT reliability. By default, this\nraw data schema is ',
            ...
            (0, s.jsx)(t.h2, {
              id: 'step-2-set-up-the-destination-connector-in-heropixel',
              children: 'Step 2: Set up the destination connector in HeroPixel',
            }),
            '\n',
            (0, s.jsxs)(t.ol, {
              children: [
                '\n',
                (0, s.jsx)(t.li, {children: 'Go to local HeroPixelpage.'}),
                '\n',
                (0, s.jsxs)(t.li, {
                  children: [

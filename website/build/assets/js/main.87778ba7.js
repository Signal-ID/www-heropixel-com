/*! For license information please see main.87778ba7.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'c18'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '6e7'),
                  routes: [
                    {

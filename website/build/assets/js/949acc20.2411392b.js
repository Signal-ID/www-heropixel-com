/*! For license information please see 949acc20.2411392b.js.LICENSE.txt */
'use strict';
    ...
    2192: (e, n, i) => {
      ...
      function c(e, n, i) {
        var o,
          ...
          c = null,
          h = null;
        for (o in (void 0 !== i && (c = '' + i),
        void 0 !== n.key && (c = '' + n.key),
        void 0 !== n.ref && (h = n.ref),
        n))
          r.call(n, o) && !l.hasOwnProperty(o) && (t[o] = n[o]);
        if (e && e.defaultProps)
          ...
          children: [
            ...
            (0, o.jsx)(n.pre, {
              children: (0, o.jsx)(n.code, {
                ...
                children:
                  '{{#if (eq income_midpts_hh 10000)}}\n  <p>Our budget-friendly options are perfect for households with an income of around $10,000.</p>\n  <div class="special-offer">Special Offer: Save big on essential products!</div>\n{{else if (eq income_midpts_hh 125000)}}\n  <p>Enjoy our premium services designed for households with a midpoint income of $125,000.</p>\n  <div class="exclusive-deals">Exclusive Deals: Access luxury items at discounted rates.</div>\n{{else if (eq income_midpts_hh 300000)}}\n  <p>Explore our high-end products and services for households with an income of $300,000.</p>\n  <div class="luxury-offers">Luxury Offers: Experience the finest quality with special privileges.</div>\n{{else}}\n  <p>Welcome! Discover our range of services and products suitable for various income levels.</p>\n  <div class="general-offers">Explore: Find the best deals tailored for you.</div>\n{{/if}}\n',
              }),
            }),
            '\n',
            (0, o.jsx)(n.p, {

...
(self.webpackChunkreact_native_website =
  ...
  [3048],
  {
    3048: (n, e, t) => {
      t.r(e),
        t.d(e, {Workbox: () => d, WorkboxEvent: () => u, messageSW: () => r});
      try {
      ...
      var d = (function (n) {
          ...
          return (
            ...
            (r.ln = function (n) {
              var e = r.fn,
                ...
                i = t.state,
                o = t === r.vn,
                a = {sw: t, isExternal: o, originalEvent: n};
              !o && r.mn && (a.isUpdate = !0),
                r.dispatchEvent(new u(i, a)),
                'installed' === i
                  ? (r.wn = self.setTimeout(function () {
                      'installed' === i &&
                        e.waiting === t &&
                        r.dispatchEvent(new u('waiting', a));
                    }, 200))
                  : 'activating' === i &&
                    (clearTimeout(r.wn), o || r.en.resolve(t));
            }),
            (r.dn = function (n) {
              var e = r.hn,
        ...
        (t = n),
          ((e = o).prototype = Object.create(t.prototype)),
        ...
        (function () {
          ...
          return (
            ...
            (e.dispatchEvent = function (n) {
              n.target = this;
              for (var e, t = a(this.Sn(n.type)); !(e = t()).done; )
                (0, e.value)(n);
            }),
            (e.Sn = function (n) {
              return (

/*! For license information please see 34bd11e4.b6f3ef76.js.LICENSE.txt */
'use strict';
    ...
    2365: (e, t, n) => {
      ...
      const r = {id: 'kafka', title: 'Kafka', description: 'desc'},
        ...
        l = {
          ...
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/kafka.md',
          tags: [],
          version: '0.0.1',
        ...
        c = [
          ...
          {
            value: 'Setup the Kafka destination in Hero Pixel',
            id: 'setup-the-kafka-destination-in-hero-pixel',
            level: 3,
          },
        ];
      function d(e) {
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [
              ...
              children: [
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    ': a uuid assigned by Hero Pixel to each event that is processed.',
                  ],
                }),
                '\n',
                (0, s.jsxs)(t.li, {
            ...
            (0, s.jsxs)(t.p, {
              children: [
                'Hero Pixel should be allowed to write messages into topics, and these topics should be created before writing into Kafka or, at least, enable the configuration in the brokers ',
            ...
            (0, s.jsx)(t.h3, {
              id: 'setup-the-kafka-destination-in-hero-pixel',
              children: 'Setup the Kafka destination in Hero Pixel',
            }),
            '\n',
            (0, s.jsx)(t.p, {
              children:

/*! For license information please see 8c814711.bf55a368.js.LICENSE.txt */
'use strict';
  ...
  [4784],
  {
    2192: (e, n, i) => {
      ...
      function l(e, n, i) {
        ...
        n))
          s.call(n, r) && !a.hasOwnProperty(r) && (o[r] = n[r]);
        if (e && e.defaultProps)
    ...
    9540: (e, n, i) => {
      ...
      const o = {
        ...
        c = {
          id: 'personalization/hero-ethnic-group-property',
          title: 'Ethnic Group Property',
          description:
            'Guide to using the ethnic group property in Hero Dynamic Text',
          source:
          ...
          slug: '/personalization/hero-ethnic-group-property',
          ...
          children: [
            ...
            (0, r.jsxs)(n.p, {
              children: [
                ...
                ' property in Hero Dynamic Text allows you to tailor your content to the ethnic background of your visitors. This guide provides an overview of how to use the ',
                (0, r.jsx)(n.code, {children: 'ethnic_group'}),
                ' property to create personalized experiences and includes a list of potential ethnic group values.',
              ],
            }),
            '\n',
            ...
            (0, r.jsxs)(n.p, {
              children: [
                'The ',
                (0, r.jsx)(n.code, {children: 'ethnic_group'}),
                " property can be used to display content that resonates with the visitor's cultural background, ensuring a more relevant and engaging experience.",
              ],
            }),
            '\n',
              ...
              children: [
                ...
                (0, r.jsxs)(n.tbody, {
                  children: [
                    (0, r.jsxs)(n.tr, {
                      children: [
                        (0, r.jsx)(n.td, {children: 'White'}),
                        (0, r.jsx)(n.td, {children: 'Caucasian or White'}),
                      ],
                    }),
                    (0, r.jsxs)(n.tr, {
                      children: [
                        (0, r.jsx)(n.td, {children: 'Hispanic'}),
                        (0, r.jsx)(n.td, {children: 'Hispanic or Latino'}),
                      ],
                    }),
                    (0, r.jsxs)(n.tr, {
                      children: [
                        (0, r.jsx)(n.td, {children: 'Asian'}),
                        (0, r.jsx)(n.td, {children: 'Asian'}),
                      ],
                    }),
                    (0, r.jsxs)(n.tr, {
                      children: [
                        (0, r.jsx)(n.td, {children: 'Jewish'}),
                        (0, r.jsx)(n.td, {children: 'Jewish'}),
                      ],
                    }),
                    (0, r.jsxs)(n.tr, {
                      children: [
                        (0, r.jsx)(n.td, {children: 'African American'}),
                        (0, r.jsx)(n.td, {children: 'African American'}),
                      ],
                    }),
                    (0, r.jsxs)(n.tr, {
                      children: [
                        (0, r.jsx)(n.td, {children: 'Other'}),
                        (0, r.jsx)(n.td, {children: 'Other'}),
                      ],
                    }),
                  ],
            ...
            (0, r.jsxs)(n.p, {
              children: [
                'Using the ',
                (0, r.jsx)(n.code, {children: 'ethnic_group'}),
                " property in Hero Dynamic Text allows you to personalize your landing pages based on the visitor's ethnic background. By leveraging this property, you can deliver a more culturally relevant user experience.",
              ],
            }),
            '\n',

  ...
  [2598, 4514, 9051, 8491],
  {
    ...
    334: (e, t, a) => {
      ...
      const c = function ({children: e}) {
        ...
        d = 'title_Bic6',
        m = 'description_jkP7';
      const u = function ({title: e, description: t}) {
        return s.createElement(
          'div',
          {className: o},
          s.createElement('h1', {className: d}, e),
          s.createElement('h3', {className: m}, t)
        );
      };
      var p = a(6158);
      function f() {
        const e = new Set(),
          t = [];
        for (const s of p.A) e.has(s.file) || (e.add(s.file), t.push(s));
          ...
          a.map((e, t) => {
            ...
            return s.createElement(
              ...
              s.createElement(
                'a',
                {href: e.url},
                s.createElement('img', {src: a, alt: e.file})
              )
            );
          })
        );
      }
      const h = 'featureContainer_JCYB';
      const g = function () {
            ...
            s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(
                  'p',
                  null,
                  'Prior to providing integrations natively we saw our customers spending thousands upon thousands of dollars on zapier connections.'
                ),
                s.createElement(
                  'p',
                  null,
                  "We didn't want our service to impose uneccessary costs onto our clients, just so they could take position of their leads. For that reason, we decided to build and maintain the necessary integrations to make our client's lives easier."
                ),
                s.createElement(
                  'p',
                  null,
                  "If you don't find the integration you're looking for, just reach out to our support team and they'll be happy to build it for you."
                )
              ),
              s.createElement(
                'div',
                ...
                s.createElement(
                  ...
                  s.createElement(
                    'a',
                    {href: (0, i.A)('/docs/intro-to-integrations')},
                    'many more'
                  ),
                  '.'
                )
          ...
          s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(
                ...
                s.createElement('div', {class: 'thumbnail'}),
                s.createElement(
                  'div',
                  {class: 'card-content'},
                  s.createElement(
                  ...
                  s.createElement(
                    'p',
                    null,
                    'Learn how to get started with HeroPixeland deploy an Advanced Remarketing Pixel on your Website in minutes.'
                  ),
                  s.createElement(
                    'ul',
                    {class: 'menu__list'},
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(
                    'p',
                    null,
                    'Need to know if we support your marketing channel? Surf through our integrations library.'
                  ),
                  s.createElement(
                    'ul',
                    {class: 'menu__list'},
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  s.createElement(
                    'p',
                    null,
                    'Open a direct line of communication from application to application using our GraphQL or REST APIs.'
                  ),
                  s.createElement(
                    'ul',
                    {class: 'menu__list'},
            ...
            s.createElement(
              ...
              s.createElement(
                ...
                s.createElement(
                  'div',
                  {class: 'column'},
                  s.createElement('h1', null, 'HeroPixelDocs'),
                  s.createElement(
                    'h2',
                    null,
                    'Help for wherever you are on your Hero journey.'
                  )
                ),
                s.createElement(
                  'div',

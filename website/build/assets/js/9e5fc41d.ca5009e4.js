/*! For license information please see 9e5fc41d.ca5009e4.js.LICENSE.txt */
'use strict';
  ...
  [6250],
  {
    2192: (e, t, n) => {
      ...
      function d(e, t, n) {
        ...
        t))
          o.call(t, s) && !c.hasOwnProperty(s) && (r[s] = t[s]);
        if (e && e.defaultProps)
    ...
    2525: (e, t, n) => {
      ...
      var s = n(2540),
        i = n(3023);
      const r = {id: 'bigquery', title: 'BigQuery', description: 'desc'},
        o = 'BigQuery',
        l = {
          id: 'destinations/bigquery',
          title: 'BigQuery',
          description: 'desc',
          source: '@site/versioned_docs/version-0.0.1/destinations/bigquery.md',
          sourceDirName: 'destinations',
          slug: '/destinations/bigquery',
          permalink: '/docs/destinations/bigquery',
          draft: !1,
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/bigquery.md',
          tags: [],
          version: '0.0.1',
          lastUpdatedAt: 1719260246e3,
          frontMatter: {id: 'bigquery', title: 'BigQuery', description: 'desc'},
          sidebar: 'integrations',
          previous: {
            title: 'AWS Datalake',
            permalink: '/docs/destinations/aws-datalake',
          },
          next: {title: 'Chroma', permalink: '/docs/destinations/chroma'},
        },
        c = {},
        d = [
          ...
          {
            value: 'Step 1: Set up a data loading method',
            id: 'step-1-set-up-a-data-loading-method',
            level: 3,
          },
          {
            value: '(Recommended) Using a Google Cloud Storage bucket',
            id: 'recommended-using-a-google-cloud-storage-bucket',
            level: 4,
          },
          {value: 'Using <code>INSERT</code>', id: 'using-insert', level: 4},
          {
            value: 'Step 2: Set up the BigQuery connector',
            id: 'step-2-set-up-the-bigquery-connector',
            level: 3,
          },
          {value: 'Supported sync modes', id: 'supported-sync-modes', level: 2},
          {value: 'Output schema', id: 'output-schema', level: 2},
          {value: 'Raw Table schema', id: 'raw-table-schema', level: 3},
          {value: 'Final Table schema', id: 'final-table-schema', level: 3},
          {
            value: 'BigQuery Naming Conventions',
            id: 'bigquery-naming-conventions',
            level: 2,
          },
          {value: 'Data type map', id: 'data-type-map', level: 2},
          {
            value: 'Troubleshooting permission issues',
      ...
      function a(e) {
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [
            (0, s.jsx)(t.h1, {id: 'bigquery', children: 'BigQuery'}),
            '\n',
            (0, s.jsx)(t.p, {
              children:
                  ...
                  children: [
                    ...
                    (0, s.jsx)(t.p, {
                      children: (0, s.jsx)(t.a, {
                        href: 'https://cloud.google.com/bigquery/docs/quickstarts/query-public-dataset-console',
                        children:
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    (0, s.jsxs)(t.p, {
                      children: [
                        (0, s.jsx)(t.a, {
                          href: 'https://cloud.google.com/bigquery/docs/quickstarts/quickstart-web-ui#create_a_dataset',
                          children: 'A BigQuery dataset',
                        }),
                        '\nto sync data to.',
                      ],
                    }),
                  ...
                  children: [
                    ...
                    (0, s.jsxs)(t.p, {
                      children: [
                        ...
                        ' with the\n',
                        (0, s.jsx)(t.a, {
                          href: 'https://cloud.google.com/bigquery/docs/access-control#bigquery',
                          children: (0, s.jsx)(t.code, {
                            children: 'BigQuery User',
                          }),
                        }),
                        ' and\n',
                        (0, s.jsx)(t.a, {
            ...
            (0, s.jsx)(t.h3, {
              id: 'step-1-set-up-a-data-loading-method',
              children: 'Step 1: Set up a data loading method',
            }),
            '\n',
            (0, s.jsxs)(t.p, {
              children: [
                ...
                (0, s.jsx)(t.a, {
                  href: 'https://cloud.google.com/bigquery/docs/reference/standard-sql/dml-syntax',
                  children: (0, s.jsx)(t.code, {children: 'INSERTS'}),
                }),
                ', we highly\nrecommend using a ',
                (0, s.jsx)(t.a, {
                  href: 'https://cloud.google.com/storage/docs/introduction',
                  children: 'Google Cloud Storage bucket',
                }),
            ...
            (0, s.jsx)(t.h4, {
              id: 'recommended-using-a-google-cloud-storage-bucket',
              children: '(Recommended) Using a Google Cloud Storage bucket',
            }),
            '\n',
            (0, s.jsx)(t.p, {
              children: 'To use a Google Cloud Storage bucket:',
            }),
            '\n',
            (0, s.jsxs)(t.ol, {
              children: [
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    (0, s.jsx)(t.a, {
                      ...
                      children: 'Create a Cloud Storage bucket',
                    }),
                    ' with the\nProtection Tools set to ',
                    (0, s.jsx)(t.code, {children: 'none'}),
                    ' or ',
                    (0, s.jsx)(t.code, {children: 'Object versioning'}),
                    '. Make sure the bucket does not have a\n',
                    (0, s.jsx)(t.a, {
                      href: 'https://cloud.google.com/storage/docs/samples/storage-set-retention-policy',
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    (0, s.jsx)(t.a, {
                      ...
                      children: 'Create an HMAC key and access ID',
                    }),
                    '.',
                  ],
                }),
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    (0, s.jsxs)(t.a, {
                      ...
                      children: [
                        (0, s.jsx)(t.code, {children: 'Storage Object Admin'}),
                        ' role',
                      ],
                    }),
                    '\nto the Google Cloud ',
                    ...
                    (0, s.jsx)(t.a, {
                      href: '#step-2-set-up-the-bigquery-connector',
                      children: 'BigQuery connector setup step',
                    }),
                    '.',
                  ],
                }),
                ...
                (0, s.jsx)(t.li, {
                  children:
                    'Make sure your Cloud Storage bucket is accessible from the machine running Airbyte. The easiest\nway to verify if Airbyte is able to connect to your bucket is via the check connection tool in\nthe UI.',
                }),
                '\n',
              ],
            }),
            ...
            (0, s.jsxs)(t.h4, {
              id: 'using-insert',
              children: ['Using ', (0, s.jsx)(t.code, {children: 'INSERT'})],
            }),
            '\n',
            (0, s.jsxs)(t.p, {
              children: [
            ...
            (0, s.jsx)(t.h3, {
              id: 'step-2-set-up-the-bigquery-connector',
              children: 'Step 2: Set up the BigQuery connector',
            }),
            '\n',
            (0, s.jsxs)(t.ol, {
              children: [
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    (0, s.jsx)(t.strong, {children: 'BigQuery'}),
                    ' from the ',
                ...
                '\n',
                (0, s.jsx)(t.li, {
                  children: 'Enter the name for the BigQuery connector.',
                }),
                '\n',
                (0, s.jsxs)(t.li, {
                  children: [
                    'For ',
                    (0, s.jsx)(t.strong, {children: 'Project ID'}),
                    ', enter your\n',
                    (0, s.jsx)(t.a, {
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    'For ',
                    (0, s.jsx)(t.strong, {children: 'Dataset Location'}),
                    ', select the location of your BigQuery dataset.',
                  ],
                }),
                '\n',
              ],
            ...
            (0, s.jsx)(t.admonition, {
              ...
              children: (0, s.jsx)(t.p, {
                children: 'You cannot change the location later.',
              }),
            }),
            '\n',
            (0, s.jsxs)(t.ol, {
              ...
              children: [
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    'For ',
                    (0, s.jsx)(t.strong, {children: 'Default Dataset ID'}),
                    ', enter the BigQuery\n',
                    (0, s.jsx)(t.a, {
                      href: 'https://cloud.google.com/bigquery/docs/datasets#create-dataset',
                      children: 'Dataset ID',
                    }),
                    '.',
                  ],
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    'For ',
                    (0, s.jsx)(t.strong, {children: 'Loading Method'}),
                    ', select ',
                    (0, s.jsx)(t.a, {
                      href: '#using-insert',
                      children: 'Standard Inserts',
                    }),
                    ' or\n',
                    (0, s.jsx)(t.a, {
                      href: '#recommended-using-a-google-cloud-storage-bucket',
                      children: 'GCS Staging',
                    }),
                    '.',
                  ],
                }),
            ...
            (0, s.jsx)(t.admonition, {
              type: 'tip',
              children: (0, s.jsx)(t.p, {
                children: 'We recommend using the GCS Staging option.',
              }),
            }),
            '\n',
            (0, s.jsxs)(t.ol, {
              ...
              children: [
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    'For ',
                    (0, s.jsx)(t.strong, {
                      children: 'Transformation Query Run Type (Optional)',
                    }),
                    ', select ',
                    (0, s.jsx)(t.strong, {children: 'interactive'}),
                    ' to have\n',
                    (0, s.jsx)(t.a, {
                      href: 'https://cloud.google.com/bigquery/docs/running-queries#queries',
                      children: 'BigQuery run interactive query jobs',
                    }),
                    '\nor ',
                    (0, s.jsx)(t.strong, {children: 'batch'}),
                    ' to have\n',
                    (0, s.jsx)(t.a, {
                      href: 'https://cloud.google.com/bigquery/docs/running-queries#batch',
                      children: 'BigQuery run batch queries',
                    }),
                    '.',
                  ],
                }),
            ...
            (0, s.jsxs)(t.ul, {
              children: [
                '\n',
                (0, s.jsx)(t.li, {children: 'Full Refresh Sync'}),
                '\n',
              ...
              children: [
                (0, s.jsx)(t.thead, {
                  children: (0, s.jsxs)(t.tr, {
                    children: [
                      (0, s.jsx)(t.th, {children: 'Migration field'}),
                  ...
                  children: [
                    ...
                    (0, s.jsxs)(t.tr, {
                      children: [
                        ...
                        (0, s.jsx)(t.td, {children: 'TIMESTAMP'}),
                      ],
                    }),
                    (0, s.jsxs)(t.tr, {
                      children: [
            ...
            '\n',
            (0, s.jsx)(t.h3, {
              id: 'final-table-schema',
              children: 'Final Table schema',
            }),
            '\n',
            (0, s.jsxs)(t.ul, {
              children: [
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    (0, s.jsx)(t.code, {children: 'airbyte_raw_id'}),
                    ': A UUID assigned by Airbyte to each event that is processed. The column type in\nBigQuery is ',
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    (0, s.jsx)(t.code, {children: 'airbyte_extracted_at'}),
                    ': A timestamp representing when the event was pulled from the data source.\nThe column type in BigQuery is ',
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    ': A JSON blob representing typing errors. You can query these results to audit\nmisformatted or unexpected data. The column type in BigQuery is ',
            ...
            (0, s.jsxs)(t.p, {
              children: [
                'The output tables in BigQuery are partitioned by the Time-unit column ',
                (0, s.jsx)(t.code, {children: 'airbyte_extracted_at'}),
                ' at a\ndaily granularity and clustered by ',
                (0, s.jsx)(t.code, {children: 'airbyte_extracted_at'}),
                ' and the table Primary Keys. Partitions\nboundaries are based on UTC time. This is useful to limit the number of partitions scanned when\nquerying these partitioned tables, by using a predicate filter (a ',
                (0, s.jsx)(t.code, {children: 'WHERE'}),
                ' clause). Filters on the\npartitioning column are used to prune the partitions and reduce the query cost. (The parameter\n',
                (0, s.jsx)(t.strong, {children: 'Require partition filter'}),
                ' is not enabled by Airbyte, but you may toggle it by updating the\nproduced tables.)',
              ],
            }),
            '\n',
            (0, s.jsx)(t.h2, {
              id: 'bigquery-naming-conventions',
              children: 'BigQuery Naming Conventions',
            }),
            '\n',
            (0, s.jsxs)(t.p, {
              children: [
                'Follow\n',
                (0, s.jsx)(t.a, {
                  href: 'https://cloud.google.com/bigquery/docs/datasets#dataset-naming',
                  children: 'BigQuery Datasets Naming conventions',
                }),
                '.',
              ],
            }),
            ...
            (0, s.jsxs)(t.p, {
              children: [
                'Airbyte converts any invalid characters into ',
                (0, s.jsx)(t.code, {children: '_'}),
                ' characters when writing data. However, since\ndatasets that begin with ',
                (0, s.jsx)(t.code, {children: '_'}),
                ' are hidden on the BigQuery Explorer panel, Airbyte prepends the\nnamespace with ',
                (0, s.jsx)(t.code, {children: 'n'}),
                ' for converted namespaces.',
              ],
            }),
            '\n',
                  ...
                  children: (0, s.jsxs)(t.tr, {
                    children: [
                      (0, s.jsx)(t.th, {
                        ...
                        children: 'Airbyte type',
                      }),
                      (0, s.jsx)(t.th, {
                        style: {textAlign: 'left'},
                        children: 'BigQuery type',
                      }),
                    ],
                  }),
                }),
            ...
            (0, s.jsx)(t.h2, {
              id: 'troubleshooting-permission-issues',
              children: 'Troubleshooting permission issues',
            }),
            '\n',
            (0, s.jsx)(t.p, {
              children:
              ...
              children: [
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    (0, s.jsx)(t.code, {children: 'BigQuery User'}),
                    ' and ',
                    (0, s.jsx)(t.code, {children: 'BigQuery Data Editor'}),
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    (0, s.jsx)(t.code, {children: 'Cloud Storage Admin'}),
                    ' role, which includes a superset of the\nrequired permissions.',
                  ],
                }),
                '\n',
              ],
            ...
            '\n',
            (0, s.jsx)(t.p, {children: 'The HMAC key is wrong.'}),
            '\n',
            (0, s.jsxs)(t.ul, {
              children: [
                '\n',

/*! For license information please see acddfeb1.1a6d570d.js.LICENSE.txt */
'use strict';
    ...
    5424: (e, t, i) => {
      ...
      const s = {id: 'pubsub', title: 'PubSub', description: 'desc'},
        ...
        c = {
          ...
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/pubsub.md',
          tags: [],
          version: '0.0.1',
        ...
        a = [
          ...
          {
            value: 'PubSub topic for Hero Pixel syncs',
            id: 'pubsub-topic-for-hero-pixel-syncs',
            level: 4,
          },
          {value: 'Service account', id: 'service-account', level: 4},
          {value: 'Service account key', id: 'service-account-key', level: 4},
          {
            value: 'Setup the PubSub destination in Hero Pixel',
            id: 'setup-the-pubsub-destination-in-hero-pixel',
            level: 3,
          },
        ];
      function d(e) {
        ...
        return (0, n.jsxs)(n.Fragment, {
          children: [
              ...
              children: [
                ...
                (0, n.jsxs)(t.li, {
                  children: [
                    ...
                    ': a uuid string assigned by Hero Pixel to each event that is processed.',
                  ],
                }),
                '\n',
                (0, n.jsxs)(t.li, {
            ...
            (0, n.jsx)(t.h4, {
              id: 'pubsub-topic-for-hero-pixel-syncs',
              children: 'PubSub topic for Hero Pixel syncs',
            }),
            '\n',
            (0, n.jsxs)(t.p, {
              children: [
                'Hero Pixel needs a topic in PubSub to write the data being streamed/synced from your data sources. If you already have a Topic into which Hero Pixel should stream/sync data, skip this section. Otherwise, follow the Google Cloud guide for ',
                (0, n.jsx)(t.a, {
            ...
            (0, n.jsxs)(t.p, {
              children: [
                'In order for Hero Pixel to stream/sync data into PubSub, it needs credentials for a ',
                (0, n.jsx)(t.a, {
                ...
                ' with the ',
                (0, n.jsx)(t.code, {children: 'Pub/Sub Editor'}),
                ' role, which grants permissions to publish messages into PubSub topics. We highly recommend that this Service Account is exclusive to Hero Pixel for ease of permissioning and auditing. However, you can use a pre-existing Service Account if you already have one with the correct permissions.',
              ],
            }),
            '\n',
            (0, n.jsxs)(t.p, {
            ...
            (0, n.jsxs)(t.p, {
              children: [
                "Service Account Keys are used to authenticate as Google Service Accounts. For Hero Pixel to leverage the permissions you granted to the Service Account in the previous step, you'll need to provide its Service Account Keys. See the ",
                (0, n.jsx)(t.a, {

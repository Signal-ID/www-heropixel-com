/*! For license information please see 62c1d973.f8466732.js.LICENSE.txt */
'use strict';
(self.webpackChunkreact_native_website =
  ...
  [136],
  {
    ...
    5333: (e, n, t) => {
      ...
      var s = t(2540),
        i = t(3023);
      const o = {id: 'mysql', title: 'MySQL', description: 'desc'},
        r = 'MySQL',
        l = {
          ...
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/mysql.md',
          tags: [],
          version: '0.0.1',
        ...
        d = [
          ...
          {
            value: 'Setup the MySQL destination in Hero Pixel',
            id: 'setup-the-mysql-destination-in-hero-pixel',
            level: 3,
          },
          {
          ...
          children: [
            ...
            (0, s.jsxs)(n.p, {
              children: [
                ...
                ' permissions. We highly recommend creating an Hero Pixel-specific user for this purpose.',
              ],
            }),
            '\n',
            (0, s.jsx)(n.h4, {
            ...
            (0, s.jsx)(n.h3, {
              id: 'setup-the-mysql-destination-in-hero-pixel',
              children: 'Setup the MySQL destination in Hero Pixel',
            }),
            '\n',
            (0, s.jsxs)(n.p, {
              children: [
                'Before setting up MySQL destination in Hero Pixel, you need to set the ',
                (0, s.jsx)(n.a, {
                ...
                ' permission. This is required cause Hero Pixel uses ',
            ...
            (0, s.jsxs)(n.p, {
              children: [
                'The following JDBC URL parameters are set by Hero Pixel and cannot be overridden by the ',
            ...
            (0, s.jsxs)(n.p, {
              children: [
                ...
                ' have direct access to the database. Hero Pixel connects to the bastion and then asks the bastion to connect directly to the server.',
              ],
            }),
            '\n',
            (0, s.jsx)(n.p, {
                  ...
                  children: [
                    ...
                    (0, s.jsxs)(n.p, {
                      children: [
                        ...
                        ' is the username that Hero Pixel should use when connection to the bastion server. This is NOT the MySQl username.',
                      ],
                    }),
                    '\n',
                  ],
                  ...
                  children: [
                    ...
                    (0, s.jsxs)(n.p, {
                      children: [
                        ...
                        ' leave this blank. Again, this is not the MySQl password, but the password for the OS-user that Hero Pixel is using to perform commands on the bastion.',
                      ],
                    }),
                    '\n',
                  ],

/*! For license information please see main.7b6591be.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'c97'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '6e1'),
                  routes: [
                    {
                    ...
                    },
                    {
                      ...
                      component: b('/docs/graphql/link-to-zapier-docs', 'b6b'),
                      exact: !0,
                    },
                    {

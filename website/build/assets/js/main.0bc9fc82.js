/*! For license information please see main.0bc9fc82.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '87f'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '38e'),
                  routes: [
                    {
                    ...
                    },
                    {
                      ...
                      component: b('/docs/leadcapture/optin-forms', '6d3'),
                      exact: !0,
                      sidebar: 'leadcapture',
                    },
                    {
                      path: '/docs/leadcapture/overview',
                      component: b('/docs/leadcapture/overview', '4b0'),
                      exact: !0,
                      sidebar: 'leadcapture',
                    },
                    {

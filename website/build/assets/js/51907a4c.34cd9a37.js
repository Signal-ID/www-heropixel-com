/*! For license information please see 51907a4c.34cd9a37.js.LICENSE.txt */
'use strict';
    ...
    8777: (e, t, s) => {
      ...
      const i = {
        ...
        r = {
          ...
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/google-sheets.md',
          tags: [],
          version: '0.0.1',
          frontMatter: {
            id: 'google-sheets',
        ...
        c = [
          ...
          },
          {
            ...
            id: 'step-2-set-up-the-google-sheets-destination-connector-in-hero-pixel',
            level: 2,
          },
          ...
          children: [
            ...
            (0, n.jsxs)(t.ol, {
              children: [
                ...
                (0, n.jsxs)(t.li, {
                  children: [
                    'Set up a new destination in Hero Pixel, select ',
            ...
            (0, n.jsxs)(t.p, {
              children: [
                'Hero Pixel only supports replicating ',
            ...
            (0, n.jsxs)(t.p, {
              children: [
                ...
                ' is 60 requests per 60 seconds per user and 300 requests per 60 seconds per project, which will result in slow sync speeds. Hero Pixel batches requests to the API in order to efficiently pull data and respects these rate limits.',
              ],
            }),
            '\n',
            (0, n.jsxs)(t.h3, {

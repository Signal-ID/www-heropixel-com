/*! For license information please see main.6ed2e7e9.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', '244'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '74d'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'ed5'),
                  routes: [
                    {

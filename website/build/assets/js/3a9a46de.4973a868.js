/*! For license information please see 3a9a46de.4973a868.js.LICENSE.txt */
'use strict';
    ...
    8807: (e, n, t) => {
      ...
      const r = {id: 'mssql', title: 'MsSQL', description: 'desc'},
        ...
        l = {
          ...
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/mssql.md',
          tags: [],
          version: '0.0.1',
        ...
        d = [
          ...
          {
            value: 'Setup the MSSQL destination in Hero Pixel',
            id: 'setup-the-mssql-destination-in-hero-pixel',
            level: 3,
          },
          {
      ...
      function a(e) {
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [
              ...
              children: [
                ...
                (0, s.jsxs)(n.li, {
                  children: [
                    ...
                    ': a uuid assigned by Hero Pixel to each event that is processed. The column type in SQL Server is ',
            ...
            (0, s.jsxs)(n.p, {
              children: [
                'Hero Pixel supports a SSL-encrypted connection to the database. If you want to use SSL to securely access your database, ensure that ',
                (0, s.jsx)(n.a, {
            ...
            (0, s.jsx)(n.h3, {
              id: 'setup-the-mssql-destination-in-hero-pixel',
              children: 'Setup the MSSQL destination in Hero Pixel',
            }),
            '\n',
            (0, s.jsx)(n.p, {
              children:
                  ...
                  children: [
                    ...
                    (0, s.jsxs)(n.p, {
                      children: [
                        ...
                        ' is the username that Hero Pixel should use when connection to the bastion server. This is NOT the MS SQL Server username.',
                      ],
                    }),
                    '\n',
                  ],

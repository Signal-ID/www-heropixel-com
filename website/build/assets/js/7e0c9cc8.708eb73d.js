/*! For license information please see 7e0c9cc8.708eb73d.js.LICENSE.txt */
'use strict';
  ...
  [5833],
  {
    2192: (e, n, t) => {
      ...
      function d(e, n, t) {
        ...
        n))
          o.call(n, i) && !a.hasOwnProperty(i) && (l[i] = n[i]);
        if (e && e.defaultProps)
          ...
          children: [
            ...
            (0, i.jsx)(n.pre, {
              children: (0, i.jsx)(n.code, {
                ...
                children:
                  '{{#if (eq dwelling_type "Single Family")}}\n  <p>Enjoy our exclusive offers and services designed for single-family homeowners.</p>\n  <img src="/images/single_family_home.jpg" alt="Single Family Home">\n{{else if (eq dwelling_type "Multi Family Dwelling/Apartment")}}\n  <p>Discover our tailored solutions and discounts for apartment and multi-family dwelling residents.</p>\n  <img src="/images/multi_family_dwelling.jpg" alt="Multi Family Dwelling/Apartment">\n{{else}}\n  <p>Welcome! Discover our services tailored to your needs.</p>\n  <img src="/images/general_services.jpg" alt="General Services">\n{{/if}}\n',
              }),
            }),
            '\n',
            (0, i.jsx)(n.p, {

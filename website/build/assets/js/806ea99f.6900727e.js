/*! For license information please see 806ea99f.6900727e.js.LICENSE.txt */
'use strict';
    ...
    6301: (e, t, n) => {
      ...
      const l = {id: 'oracle', title: 'Oracle', description: 'desc'},
        ...
        o = {
          ...
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/oracle.md',
          tags: [],
          version: '0.0.1',
        ...
        d = [
          ...
          {
            value: 'Setup the Oracle destination in Hero Pixel',
            id: 'setup-the-oracle-destination-in-hero-pixel',
            level: 3,
          },
      ...
      function a(e) {
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [
              ...
              children: [
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    ': a uuid assigned by Hero Pixel to each event that is processed. The column type in Oracle is ',
            ...
            (0, s.jsx)(t.h3, {
              id: 'setup-the-oracle-destination-in-hero-pixel',
              children: 'Setup the Oracle destination in Hero Pixel',
            }),
            '\n',
            (0, s.jsx)(t.p, {
              children:
              ...
              children: [
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    ' is the username that Hero Pixel should use when connection to the bastion server. This is NOT the Oracle username.',
                  ],
                }),
                '\n',
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    (0, s.jsx)(t.code, {children: 'SSH Key Authentication'}),
                    ' leave this blank. Again, this is not the Oracle password, but the password for the OS-user that Hero Pixel is using to perform commands on the bastion.',
                  ],
                }),
                '\n',
                (0, s.jsxs)(t.li, {

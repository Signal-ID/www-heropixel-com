/*! For license information please see 69ff6227.cd4d358e.js.LICENSE.txt */
'use strict';
(self.webpackChunkreact_native_website =
  ...
  [957],
  {
    2192: (e, n, t) => {
      ...
      function a(e, n, t) {
        var s,
          ...
          a = null,
          d = null;
        for (s in (void 0 !== t && (a = '' + t),
        void 0 !== n.key && (a = '' + n.key),
        void 0 !== n.ref && (d = n.ref),
        n))
          l.call(n, s) && !c.hasOwnProperty(s) && (r[s] = n[s]);
        if (e && e.defaultProps)
    ...
    5141: (e, n, t) => {
      ...
      var s = t(2540),
        i = t(3023);
      const r = {id: 's3', title: 'S3', description: 's3'},
        l = 'S3',
        o = {
          id: 'destinations/s3',
          title: 'S3',
          description: 's3',
          source: '@site/versioned_docs/version-0.0.1/destinations/s3.md',
          sourceDirName: 'destinations',
          slug: '/destinations/s3',
          permalink: '/docs/destinations/s3',
          draft: !1,
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/s3.md',
          tags: [],
          version: '0.0.1',
          frontMatter: {id: 's3', title: 'S3', description: 's3'},
          sidebar: 'integrations',
          previous: {
            title: 'Redshift',
            permalink: '/docs/destinations/redshift',
          },
          next: {title: 'S3 Glue', permalink: '/docs/destinations/s3-glue'},
        },
        c = {},
        a = [
          {value: 'Prerequisites', id: 'prerequisites', level: 2},
          {value: 'Setup guide', id: 'setup-guide', level: 2},
          {value: 'Step 1: Set up S3', id: 'step-1-set-up-s3', level: 3},
          {
            value: 'Create bucket a Policy',
            id: 'create-bucket-a-policy',
            level: 4,
          },
          {
            value: 'Authentication Option 1: Using an IAM Role (Most secure)',
            id: 'authentication-option-1-using-an-iam-role-most-secure',
            level: 4,
          },
          {
            value: 'Authentication Option 2: Using an IAM User',
            id: 'authentication-option-2-using-an-iam-user',
            level: 5,
          },
          {
            value: 'Step 2: Set up the S3 destination connector in Hero Pixel',
            id: 'step-2-set-up-the-s3-destination-connector-in-hero-pixel',
            level: 3,
          },
          ...
          {value: 'Configuration', id: 'configuration', level: 4},
      ...
      function d(e) {
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [
            (0, s.jsx)(n.h1, {id: 's3', children: 'S3'}),
            '\n',
            (0, s.jsx)(n.p, {
              children:
            ...
            (0, s.jsxs)(n.ul, {
              children: [
                '\n',
                (0, s.jsx)(n.li, {
                  children: (0, s.jsx)(n.strong, {children: 'Role ARN'}),
                }),
                '\n',
              ],
            }),
            ...
            (0, s.jsxs)(n.ol, {
              children: [
                ...
                (0, s.jsx)(n.li, {
                  children:
                    'Allow connections from Hero Pixel server to your AWS S3/ Minio S3 cluster (if they exist in\nseparate VPCs).',
                }),
                '\n',
                (0, s.jsx)(n.li, {
                  children:
                    'An S3 bucket with credentials, a Role ARN, or an instance profile with read/write permissions configured for\nthe host (ec2, eks).',
                }),
                '\n',
                (0, s.jsx)(n.li, {
            ...
            (0, s.jsx)(n.h4, {
              id: 'create-bucket-a-policy',
              children: 'Create bucket a Policy',
            }),
            '\n',
            (0, s.jsxs)(n.ol, {
              children: [
                ...
                (0, s.jsxs)(n.li, {
                  children: [
                    'In the IAM dashboard, select ',
                    (0, s.jsx)(n.strong, {children: 'Policies'}),
                    ', then click ',
                    (0, s.jsx)(n.strong, {children: 'Create Policy'}),
                    '.',
                  ],
                }),
                '\n',
                (0, s.jsxs)(n.li, {
                  children: [
                    'Select the ',
                    (0, s.jsx)(n.strong, {children: 'JSON'}),
                    ' tab, then paste the following JSON into the Policy editor (be sure to substitute in your bucket name):',
                  ],
                }),
                '\n',
              ],
            ...
            (0, s.jsx)(n.admonition, {
              ...
              children: (0, s.jsxs)(n.p, {
                children: [
                  'At this time, object-level permissions alone are not sufficient to successfully authenticate the connection. Please ensure you include the ',
                  (0, s.jsx)(n.strong, {children: 'bucket-level'}),
            ...
            (0, s.jsxs)(n.ol, {
              ...
              children: [
                ...
                (0, s.jsxs)(n.li, {
                  children: [
                    'Give your policy a descriptive name, then click ',
                    (0, s.jsx)(n.strong, {children: 'Create policy'}),
                    '.',
                  ],
                }),
            ...
            (0, s.jsx)(n.admonition, {
              ...
              children: (0, s.jsxs)(n.p, {
                children: [
                  "S3 authentication using an IAM role member must be enabled by a member of the Hero Pixel team. If you'd like to use this feature, please ",
                  (0, s.jsx)(n.a, {
                    href: 'mailto:support@heropixel.com',
                    children: 'contact the tech team',
                  }),
            ...
            (0, s.jsxs)(n.ol, {
              children: [
                ...
                (0, s.jsxs)(n.li, {
                  children: [
                    'In the IAM dashboard, click ',
                    (0, s.jsx)(n.strong, {children: 'Roles'}),
                    ', then ',
                    (0, s.jsx)(n.strong, {children: 'Create role'}),
                    '. ',
                  ],
                }),
                '\n',
                ...
                (0, s.jsxs)(n.li, {
                  children: [
                    'Set up a trust relationship for the role. For example for ',
                    (0, s.jsx)(n.strong, {children: 'AWS account'}),
                    ' trusted entity use default AWS account on your instance (it will be used to assume role). To use ',
                    (0, s.jsx)(n.strong, {children: 'External ID'}),
                    ' set it to environment variables as ',
                    (0, s.jsx)(n.code, {
                      children:
            ...
            (0, s.jsxs)(n.ol, {
              ...
              children: [
                '\n',
                (0, s.jsx)(n.li, {
                  children: 'Complete the role creation and note the Role ARN.',
                }),
                '\n',
                (0, s.jsxs)(n.li, {
                  children: [
                    'Select ',
                    (0, s.jsx)(n.strong, {
                      children: 'Attach policies directly',
                    }),
                    ', then find and check the box for your new policy. Click ',
                    (0, s.jsx)(n.strong, {children: 'Next'}),
                    ', then ',
                    (0, s.jsx)(n.strong, {children: 'Add permissions'}),
                    '.',
                  ],
                }),
                '\n',
            ...
            (0, s.jsx)(n.h5, {
              id: 'authentication-option-2-using-an-iam-user',
              children: 'Authentication Option 2: Using an IAM User',
            }),
            '\n',
            (0, s.jsxs)(n.p, {
              children: [
            ...
            (0, s.jsxs)(n.ol, {
              children: [
                ...
                (0, s.jsxs)(n.li, {
                  children: [
                    'In the IAM dashboard, click ',
                    (0, s.jsx)(n.strong, {children: 'Users'}),
                    '. Select an existing IAM user or create a new one by clicking ',
                    (0, s.jsx)(n.strong, {children: 'Add users'}),
                    '.',
                  ],
                }),
                '\n',
                (0, s.jsxs)(n.li, {
                  children: [
                    'If you are using an ',
                    (0, s.jsx)(n.em, {children: 'existing'}),
                    ' IAM user, click the ',
                    (0, s.jsx)(n.strong, {children: 'Add permissions'}),
                    ' dropdown menu and select ',
                    (0, s.jsx)(n.strong, {children: 'Add permissions'}),
                    '. If you are creating a ',
                    (0, s.jsx)(n.em, {children: 'new'}),
                    ' user, you will be taken to the Permissions screen after selecting a name.',
                  ],
                }),
                '\n',
                (0, s.jsxs)(n.li, {
                ...
                (0, s.jsxs)(n.li, {
                  children: [
                    'After successfully creating your user, select the ',
                    (0, s.jsx)(n.strong, {children: 'Security credentials'}),
                    ' tab and click ',
                    (0, s.jsx)(n.strong, {children: 'Create access key'}),
                    '. You will be prompted to select a use case and add optional tags to your access key. Click ',
                    (0, s.jsx)(n.strong, {children: 'Create access key'}),
            ...
            (0, s.jsxs)(n.ol, {
              children: [
                ...
                (0, s.jsxs)(n.li, {
                  children: [
                    '\n',
                    (0, s.jsx)(n.p, {children: 'Go to local Hero Pixel page.'}),
                    '\n',
                  ],
                }),
                '\n',
                  ...
                  children: [
                    ...
                    (0, s.jsxs)(n.p, {
                      children: [
                        ...
                        ' to\ncreate an S3 bucket. _ ',
                        (0, s.jsx)(n.strong, {children: 'S3 Bucket Path'}),
                        ' _ Subdirectory under the above bucket to sync the data\ninto. _ ',
                        (0, s.jsx)(n.strong, {children: 'S3 Bucket Region'}),
                        ' _ See\n',
                        (0, s.jsx)(n.a, {
                          href: 'https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-available-regions',
                          children: 'here',
                        }),
                        '\nfor all region codes. _ ',
                        (0, s.jsx)(n.strong, {children: 'S3 Path Format'}),
                        ' _ Additional string format on how to store data under\nS3 Bucket Path. Default value is ',
                        (0, s.jsx)(n.code, {
                          children:
                      ...
                      children: [
                        ...
                        (0, s.jsxs)(n.li, {
                          children: [
                            ...
                            ' * The pattern allows you to set the file-name format for the S3\nstaging file(s), next placeholders combinations are currently supported: ',
                            (0, s.jsx)(n.code, {children: '{date}'}),
                            ',\n',
                            (0, s.jsx)(n.code, {children: '{date:yyyy_MM}'}),
                            ', ',
                            ...
                            ', ',
                            (0, s.jsx)(n.code, {children: '{part_number}'}),
                            ',\n',
                    ...
                    (0, s.jsxs)(n.tr, {
                      children: [
                        ...
                        (0, s.jsx)(n.td, {
                          style: {textAlign: 'left'},
                          children:
                            'Warning: Hero Pixel provides at-least-once delivery.',
                        }),
                      ],
                    }),
                    (0, s.jsxs)(n.tr, {
            ...
            (0, s.jsxs)(n.p, {
              children: [
                ...
                ' serializes data in a compact binary format. Currently, the\nHero Pixel S3 Avro connector always uses the\n',
                (0, s.jsx)(n.a, {
            ...
            (0, s.jsxs)(n.ul, {
              children: [
                ...
                (0, s.jsxs)(n.li, {
                  children: [
                    (0, s.jsx)(n.code, {children: 'deflate'}),
                    '\n',
                    (0, s.jsxs)(n.ul, {
                      children: [
                        '\n',
                ...
                '\n',
                (0, s.jsx)(n.li, {
                  children: (0, s.jsx)(n.code, {children: 'bzip2'}),
                }),
                '\n',
                (0, s.jsxs)(n.li, {
                  children: [
                    (0, s.jsx)(n.code, {children: 'xz'}),
                    '\n',
                    (0, s.jsxs)(n.ul, {
                      children: [
                        '\n',
                ...
                (0, s.jsxs)(n.li, {
                  children: [
                    (0, s.jsx)(n.code, {children: 'zstandard'}),
                    '\n',
                    (0, s.jsxs)(n.ul, {
                      children: [
                        '\n',
                              ...
                              children: [
                                ...
                                (0, s.jsxs)(n.li, {
                                  children: [
                                    ...
                                    (0, s.jsx)(n.code, {children: 'lz4'}),
                                    ' or ',
                                    (0, s.jsx)(n.code, {children: 'snappy'}),
                                    '.',
                                  ],
                                }),
                                '\n',
                ...
                '\n',
                (0, s.jsx)(n.li, {
                  children: (0, s.jsx)(n.code, {children: 'snappy'}),
                }),
                '\n',
              ],
            }),
                ...
                (0, s.jsx)(n.thead, {
                  children: (0, s.jsxs)(n.tr, {
                    children: [
                      ...
                      (0, s.jsx)(n.th, {
                        style: {textAlign: 'left'},
                        children: (0, s.jsx)(n.code, {children: 'user_id'}),
                      }),
                      (0, s.jsx)(n.th, {
                        style: {textAlign: 'left'},
                        children: (0, s.jsx)(n.code, {children: 'name'}),
                      }),
                    ],
                  }),
                }),
            ...
            (0, s.jsxs)(n.p, {
              children: [
                ...
                (0, s.jsx)(n.code, {children: '.csv.gz'}),
                ').',
              ],
            }),
            '\n',
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        (0, s.jsxs)(n.td, {
                          ...
                          children: [
                            ...
                            (0, s.jsx)(n.code, {children: 'UNCOMPRESSED'}),
                            ', ',
                            (0, s.jsx)(n.code, {children: 'SNAPPY'}),
                            ', ',
                            (0, s.jsx)(n.code, {children: 'GZIP'}),
                            ', ',
                            (0, s.jsx)(n.code, {children: 'LZO'}),
                            ', ',
                            (0, s.jsx)(n.code, {children: 'BROTLI'}),
                            ', ',
                            (0, s.jsx)(n.code, {children: 'LZ4'}),
                            ', and ',
                            (0, s.jsx)(n.code, {children: 'ZSTD'}),
                            '.',
                          ],
                        }),
                      ],
                    ...
                    (0, s.jsxs)(n.tr, {
                      children: [
                        ...
                        (0, s.jsxs)(n.td, {
                          style: {textAlign: 'left'},
                          children: [
                            (0, s.jsx)(n.strong, {children: 'Page size'}),
                    ...
                    (0, s.jsxs)(n.tr, {
                      children: [
                        ...
                        (0, s.jsx)(n.td, {
                          style: {textAlign: 'center'},
                          children: (0, s.jsx)(n.code, {children: 'true'}),
                        }),
                        (0, s.jsxs)(n.td, {
                          style: {textAlign: 'left'},
                          children: [
            ...
            (0, s.jsxs)(n.p, {
              children: [
                ...
                (0, s.jsx)(n.code, {children: 'ParquetOutputFormat'}),
                '. See the\n',
                (0, s.jsx)(n.a, {

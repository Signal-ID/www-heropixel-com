/*! For license information please see main.c14daa3f.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '8ae'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '3aa'),
                  routes: [
                    {
                    ...
                    },
                    {
                      ...
                      component: b('/docs/intro-to-pixel-tech', '2b4'),
                      exact: !0,
                      sidebar: 'docs',
                    },
                    {

/*! For license information please see main.f206f84c.js.LICENSE.txt */
  ...
  [8792],
  {
    ...
    9246: (e, t, n) => {
      ...
      const s = {
        ...
        a6a3c04f: [
          () => n.e(8481).then(n.bind(n, 2698)),
          '@site/versioned_docs/version-0.0.1/graphql/domains-graphql-request.md',
          2698,
        ],
        a6aa9e1f: [
          () =>
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '37d'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'f52'),
                  routes: [
                    {
                    ...
                    {
                      path: '/docs/graphql/domains-graphql-request',
                      component: b(
                        '/docs/graphql/domains-graphql-request',
                        '1c4'
                      ),
                      exact: !0,
                      sidebar: 'graphql',

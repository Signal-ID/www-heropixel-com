/*! For license information please see 0b28e19f.6e676bb5.js.LICENSE.txt */
'use strict';
          ...
          children: [
            ...
            (0, s.jsxs)(t.p, {
              children: [
                ...
                "\nThis section should contain a table mapping each of the connector's data types to HeroPixeltypes. At the moment, HHeroPixelses the same types used by ",
                (0, s.jsx)(t.a, {
              ...
              children: [
                ...
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    ' is the username that HeroPixelshould use when connection to the bastion server. This is NOT the TiDB username.',
                  ],
                }),
                '\n',
                (0, s.jsxs)(t.li, {
                  children: [
                    ...
                    (0, s.jsx)(t.code, {children: 'SSH Key Authentication'}),
                    ' TiDB password, but the password for the OS-user that HeroPixelis using to perform commands on the bastion.',
                  ],
                }),
                '\n',
                (0, s.jsxs)(t.li, {

      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'fd0'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'b2b'),
                  routes: [
                    {

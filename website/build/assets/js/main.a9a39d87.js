      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '912'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '441'),
                  routes: [
                    {

/*! For license information please see main.3457d6ea.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', '244'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '580'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'faf'),
                  routes: [
                    {

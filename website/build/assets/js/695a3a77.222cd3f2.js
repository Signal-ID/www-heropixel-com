/*! For license information please see 695a3a77.222cd3f2.js.LICENSE.txt */
'use strict';
  ...
  [6460],
  {
    ...
    2192: (e, s, t) => {
      ...
      function d(e, s, t) {
        var a,
          ...
          d = null,
          c = null;
        for (a in (void 0 !== t && (d = '' + t),
        void 0 !== s.key && (d = '' + s.key),
        void 0 !== s.ref && (c = s.ref),
        s))
          o.call(s, a) && !l.hasOwnProperty(a) && (n[a] = s[a]);
        if (e && e.defaultProps)
    ...
    6821: (e, s, t) => {
        ...
        return n.createElement(
          ...
          n.createElement(
            ...
            n.createElement(
              'tr',
              null,
              n.createElement('th', null, 'Logo'),
              n.createElement('th', null, 'Title'),
              n.createElement('th', null, 'Description'),
              n.createElement('th', null, 'Link')
            )
          ),
          n.createElement(
            'tbody',
            ...
            r.A.map((e, s) =>
              n.createElement(
                ...
                n.createElement('td', null, e.description),
                n.createElement(
                  'td',
                  null,
                  n.createElement('a', {href: e.url}, 'Documentation')
                )
              )
            )
          )
      ...
      const d = {
        ...
        c = 'Hero Pixel Leads to Destinations',
        u = {
          id: 'intro-to-integrations',
          title: 'Overview of Destinations',
          description: 'desc',
        ...
        g = [];
      function f(e) {
        const s = {h1: 'h1', p: 'p', ...(0, i.R)(), ...e.components};
        return (0, a.jsxs)(a.Fragment, {
          children: [
            (0, a.jsx)(s.h1, {
              id: 'hero-pixel-leads-to-destinations',
              children: 'Hero Pixel Leads to Destinations',
            }),
            '\n',
            (0, a.jsx)(s.p, {
              children:
        ...
        return (
          (s = e.disableParentContext
            ? 'function' == typeof e.components
              ...
              : e.components || i
            : o(e.components)),
          a.createElement(n.Provider, {value: s}, e.children)
        );
      }
    },
  },

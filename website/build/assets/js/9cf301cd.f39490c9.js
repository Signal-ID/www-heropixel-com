/*! For license information please see 9cf301cd.f39490c9.js.LICENSE.txt */
'use strict';
    ...
    3919: (e, n, t) => {
      ...
      const r = {id: 'dynamodb', title: 'DynamoDB', description: 'desc'},
        ...
        o = {
          ...
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/dynamodb.md',
          tags: [],
          version: '0.0.1',
          ...
          children: [
            ...
            (0, s.jsxs)(n.ol, {
              children: [
                ...
                (0, s.jsx)(n.li, {
                  children:
                    'Allow connections from Hero Pixel server to your AWS DynamoDB tables (if they exist in separate\nVPCs).',
                }),
                '\n',
                (0, s.jsx)(n.li, {
                  children:

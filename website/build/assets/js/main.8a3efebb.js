/*! For license information please see main.8a3efebb.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '1cc'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '319'),
                  routes: [
                    {

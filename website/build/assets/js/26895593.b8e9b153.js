/*! For license information please see 26895593.b8e9b153.js.LICENSE.txt */
'use strict';
  ...
  [3404],
  {
    2192: (e, i, t) => {
      ...
      function c(e, i, t) {
        ...
        i))
          l.call(i, n) && !a.hasOwnProperty(n) && (o[n] = i[n]);
        if (e && e.defaultProps)
    ...
    5473: (e, i, t) => {
      ...
      const o = {
        ...
        l = 'Political Party Property',
        s = {
          id: 'personalization/political-party-property',
          title: 'Political Party Property',
          description: 'Guide to using the political party property',
          source:
            '@site/versioned_docs/version-0.0.1/personalization/hero-political-party-property.md',
          sourceDirName: 'personalization',
          slug: '/personalization/political-party-property',
          ...
          children: [
            ...
            (0, n.jsx)(i.pre, {
              children: (0, n.jsx)(i.code, {
                ...
                children:
                  '{{#if (eq Political_Party "Conservative")}}\n  <p>Welcome, Conservative! Check out our policies that align with your values.</p>\n  <img src="/images/conservative_policies.jpg" alt="Conservative Policies">\n{{else if (eq Political_Party "Republican")}}\n  <p>Welcome, Republican! Explore our conservative policies and initiatives.</p>\n  <img src="/images/republican_policies.jpg" alt="Republican Policies">\n{{else}}\n  <p>Welcome! Explore our range of policies and initiatives.</p>\n  <img src="/images/general_policies.jpg" alt="General Policies">\n{{/if}}\n',
              }),
            }),
            '\n',
            (0, n.jsx)(i.p, {

/*! For license information please see a6a3c04f.1bc0bfca.js.LICENSE.txt */
'use strict';
  ...
  [8481],
  {
    2192: (e, n, s) => {
      ...
      function l(e, n, s) {
        var i,
          ...
          l = null,
          c = null;
        for (i in (void 0 !== s && (l = '' + s),
        void 0 !== n.key && (l = '' + n.key),
        void 0 !== n.ref && (c = n.ref),
        n))
          d.call(n, i) && !o.hasOwnProperty(i) && (t[i] = n[i]);
        if (e && e.defaultProps)
          for (i in (n = e.defaultProps)) void 0 === t[i] && (t[i] = n[i]);
        return {
          $$typeof: a,
          type: e,
          key: l,
    ...
    2698: (e, n, s) => {
      ...
      const t = {
        ...
        d = 'Pixel Domains API Documentation',
        r = {
          id: 'graphql/domains-graphql-request',
          title: 'Pixel Domains API',
          description: 'Manage domains associated with pixels',
          source:
            '@site/versioned_docs/version-0.0.1/graphql/domains-graphql-request.md',
          sourceDirName: 'graphql',
          slug: '/graphql/domains-graphql-request',
          permalink: '/docs/graphql/domains-graphql-request',
          draft: !1,
          unlisted: !1,
          tags: [],
          version: '0.0.1',
          lastUpdatedAt: 175819309e4,
          frontMatter: {
            id: 'domains-graphql-request',
            title: 'Pixel Domains API',
            description: 'Manage domains associated with pixels',
        ...
        l = [
          ...
          {
            value: 'Mutation: <code>domains</code>',
            id: 'mutation-domains',
            level: 3,
          },
          ...
          {
            value: '<code>ApiDomainsEventInput</code> Fields',
            id: 'apidomainseventinput-fields',
            level: 4,
          },
          {
            value: 'Example Request: Add Domain',
            id: 'example-request-add-domain',
            level: 4,
          },
          {
            value: 'Example CURL Request: Add Domain',
            id: 'example-curl-request-add-domain',
            level: 4,
          },
          {
            value: 'Example Response: Add Domain',
            id: 'example-response-add-domain',
            level: 4,
          },
          {
            value: 'Example Request: Remove Domain',
            id: 'example-request-remove-domain',
            level: 4,
          },
          {
            value: 'Example Response: Remove Domain',
            id: 'example-response-remove-domain',
            level: 4,
          },
          {
            value: 'Example Request: List Domains',
            id: 'example-request-list-domains',
            level: 4,
          },
          {
            value: 'Example Response: List Domains',
            id: 'example-response-list-domains',
            level: 4,
          },
          {value: 'Error Responses', id: 'error-responses', level: 4},
          {
            value: 'Domain Already Exists',
            id: 'domain-already-exists',
            level: 5,
          },
          {value: 'Domain Not Found', id: 'domain-not-found', level: 5},
          {
      ...
      function c(e) {
        ...
        return (0, i.jsxs)(i.Fragment, {
          children: [
            (0, i.jsx)(n.h1, {
              id: 'pixel-domains-api-documentation',
              children: 'Pixel Domains API Documentation',
            }),
            '\n',
            ...
            (0, i.jsxs)(n.ol, {
              children: [
                ...
                (0, i.jsxs)(n.li, {
                  children: [
                    (0, i.jsx)(n.strong, {children: 'Domain Management'}),
                    ': You can add, remove, or list domains associated with a specific pixel.',
                  ],
                }),
                '\n',
                (0, i.jsxs)(n.li, {
                  children: [
                    (0, i.jsx)(n.strong, {children: 'Domain Validation'}),
                    ': When adding a domain, the system validates and cleans the domain format.',
                  ],
                }),
                '\n',
                (0, i.jsxs)(n.li, {
                  children: [
                    (0, i.jsx)(n.strong, {children: 'Response Handling'}),
                    ': The API returns confirmation of successful operations or detailed error messages.',
                  ],
                }),
                '\n',
              ],
            ...
            (0, i.jsxs)(n.p, {
              children: [
                'All operations require authentication. The ',
            ...
            (0, i.jsxs)(n.h3, {
              ...
              children: [
                'Mutation: ',
                (0, i.jsx)(n.code, {children: 'domains'}),
              ],
            }),
            '\n',
            (0, i.jsx)(n.p, {
              children: 'Manages domains associated with a pixel.',
            }),
            '\n',
                  ...
                  children: [
                    (0, i.jsxs)(n.tr, {
                      children: [
                        ...
                        (0, i.jsx)(n.td, {children: 'AuthRequestInput'}),
                    ...
                    (0, i.jsxs)(n.tr, {
                      children: [
                        ...
                        (0, i.jsx)(n.td, {children: 'ApiDomainsEventInput'}),
                        (0, i.jsx)(n.td, {children: 'Yes'}),
                        (0, i.jsx)(n.td, {
                          children: 'Details of the domains operation.',
                        }),
                      ],
                    }),
                  ],
            ...
            (0, i.jsxs)(n.h4, {
              id: 'apidomainseventinput-fields',
              children: [
                (0, i.jsx)(n.code, {children: 'ApiDomainsEventInput'}),
                ' Fields',
              ],
            }),
            '\n',
                ...
                (0, i.jsxs)(n.tbody, {
                  children: [
                    ...
                    (0, i.jsxs)(n.tr, {
                      children: [
                        (0, i.jsx)(n.td, {
                          children: (0, i.jsx)(n.code, {children: 'action'}),
                        }),
                        (0, i.jsx)(n.td, {children: 'String'}),
                        (0, i.jsx)(n.td, {children: 'Yes'}),
                        (0, i.jsx)(n.td, {
                    ...
                    (0, i.jsxs)(n.tr, {
                      children: [
                        ...
                        (0, i.jsx)(n.td, {
                          children:
                            "The domain to add or remove (required for 'add' and 'remove').",
                        }),
                      ],
                    }),
                  ],
            ...
            (0, i.jsx)(n.h4, {
              id: 'example-request-add-domain',
              children: 'Example Request: Add Domain',
            }),
            '\n',
            (0, i.jsx)(n.pre, {
              children: (0, i.jsx)(n.code, {
            ...
            (0, i.jsx)(n.h4, {
              id: 'example-curl-request-add-domain',
              children: 'Example CURL Request: Add Domain',
            }),
            '\n',
            (0, i.jsx)(n.pre, {
              children: (0, i.jsx)(n.code, {
            ...
            (0, i.jsx)(n.h4, {
              id: 'example-response-add-domain',
              children: 'Example Response: Add Domain',
            }),
            '\n',
            (0, i.jsx)(n.pre, {
              children: (0, i.jsx)(n.code, {
            ...
            (0, i.jsx)(n.h4, {
              id: 'example-request-remove-domain',
              children: 'Example Request: Remove Domain',
            }),
            '\n',
            (0, i.jsx)(n.pre, {
              children: (0, i.jsx)(n.code, {
            ...
            (0, i.jsx)(n.h4, {
              id: 'example-response-remove-domain',
              children: 'Example Response: Remove Domain',
            }),
            '\n',
            (0, i.jsx)(n.pre, {
              children: (0, i.jsx)(n.code, {
            ...
            (0, i.jsx)(n.h4, {
              id: 'example-request-list-domains',
              children: 'Example Request: List Domains',
            }),
            '\n',
            (0, i.jsx)(n.pre, {
              children: (0, i.jsx)(n.code, {
            ...
            (0, i.jsx)(n.h4, {
              id: 'example-response-list-domains',
              children: 'Example Response: List Domains',
            }),
            '\n',
            (0, i.jsx)(n.pre, {
              children: (0, i.jsx)(n.code, {
            ...
            (0, i.jsx)(n.h5, {
              id: 'domain-already-exists',
              children: 'Domain Already Exists',
            }),
            '\n',
            (0, i.jsx)(n.pre, {
              children: (0, i.jsx)(n.code, {
            ...
            (0, i.jsx)(n.h5, {
              id: 'invalid-domain-format',
              children: 'Invalid Domain Format',
            }),
            '\n',
            (0, i.jsx)(n.pre, {
              children: (0, i.jsx)(n.code, {
                  ...
                  children: [
                    ...
                    (0, i.jsxs)(n.ul, {
                      children: [
                        ...
                        (0, i.jsxs)(n.li, {
                          children: [
                            (0, i.jsx)(n.code, {children: '409'}),
                            ': Conflict, such as duplicate domain.',
                          ],
                        }),
                        '\n',
                        (0, i.jsxs)(n.li, {
            ...
            (0, i.jsxs)(n.p, {
              children: [
                'For additional support or questions about the Pixel Domains API, contact our development team at ',
                (0, i.jsx)(n.a, {
                  href: 'mailto:support@heropixel.com',
                  children: 'support@heropixel.com',
                }),

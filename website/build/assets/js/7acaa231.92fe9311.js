/*! For license information please see 7acaa231.92fe9311.js.LICENSE.txt */
'use strict';
    ...
    9539: (e, t, n) => {
      ...
      const s = {id: 'vectara', title: 'Vectara', description: 'vectara'},
        ...
        l = [
          ...
          {
            value: 'Setup the Vectara Destination in HeroPixel',
            id: 'setup-the-vectara-destination-in-heropixel',
            level: 3,
          },
        ];
      function d(e) {
        ...
        return (0, r.jsxs)(r.Fragment, {
          children: [
            ...
            (0, r.jsx)(t.p, {
              children:
                'The Vectara destination connector allows you to connect any HeroPixelsource to Vectara and ingest data into Vectara for your RAG pipeline.',
            }),
            '\n',
            ...
            (0, r.jsx)(t.p, {
              children:
                'Note that there are no restrictions in naming the Vectara corpus and if a corpus with the specified name is not found, a new corpus with that name will be created. Also, if multiple corpora exists with the same name, an error will be returned as HeroPixelwill be unable to determine the prefered corpus.',
            }),
            '\n',
            ...
            (0, r.jsx)(t.p, {
              children:
                'You will need a Vectara account to use Vectara with HeroPixel To get started, use the following steps:',
            }),
            '\n',
            (0, r.jsxs)(t.ol, {
              children: [
            ...
            (0, r.jsx)(t.h3, {
              id: 'setup-the-vectara-destination-in-heropixel',
              children: 'Setup the Vectara Destination in HeroPixel',
            }),
            '\n',
            (0, r.jsx)(t.p, {
              children:

/*! For license information please see main.386bd116.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '37b'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '6f1'),
                  routes: [
                    {
                    ...
                    },
                    {
                      ...
                      component: b('/docs/destinations/gohighlevel', '76b'),
                      exact: !0,
                      sidebar: 'integrations',
                    },
                    {

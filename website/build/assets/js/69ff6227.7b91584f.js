/*! For license information please see 69ff6227.7b91584f.js.LICENSE.txt */
'use strict';
    ...
    5141: (e, n, t) => {
      ...
      const r = {id: 's3', title: 'S3', description: 's3'},
        ...
        a = [
          ...
          {
            value: 'Step 2: Set up the S3 destination connector in HeroPixel',
            id: 'step-2-set-up-the-s3-destination-connector-in-heropixel',
            level: 3,
          },
        ...
        return (0, s.jsxs)(s.Fragment, {
          children: [
            ...
            (0, s.jsx)(n.admonition, {
              ...
              children: (0, s.jsxs)(n.p, {
                children: [
                  "S3 authentication using an IAM role member must be enabled by a member of the HeroPixelteam. If you'd like to use this feature, please ",
                  (0, s.jsx)(n.a, {
                    ...
                    (0, s.jsxs)(n.tr, {
                      children: [
                        ...
                        (0, s.jsx)(n.td, {
                          style: {textAlign: 'left'},
                          children:
                            'A uuid assigned by HeroPixelto each processed record.',
                        }),
                      ],
                    }),
                    (0, s.jsxs)(n.tr, {

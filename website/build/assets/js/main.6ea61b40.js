/*! For license information please see main.6ea61b40.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', '244'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'b29'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'cac'),
                  routes: [
                    {

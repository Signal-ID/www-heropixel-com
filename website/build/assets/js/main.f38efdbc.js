/*! For license information please see main.f38efdbc.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', '244'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'e46'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '84f'),
                  routes: [
                    {
                    ...
                    },
                    {
                      ...
                      component: b('/docs/intro-to-suppressing', '976'),
                      exact: !0,
                      sidebar: 'docs',
                    },
                    {

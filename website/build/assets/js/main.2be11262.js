/*! For license information please see main.2be11262.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', '244'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '78b'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '0eb'),
                  routes: [
                    {

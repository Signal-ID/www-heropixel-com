/*! For license information please see 6733b374.f53acad9.js.LICENSE.txt */
'use strict';
          ...
          children: [
            ...
            (0, s.jsx)(n.pre, {
              children: (0, s.jsx)(n.code, {
                ...
                children:
                  '{{#if (eq income_levels "100K_150")}}\n  <p>Enjoy our premium content and services tailored for high-income households.</p>\n  <div class="exclusive-offer">Exclusive offer: Get 20% off on our luxury product range!</div>\n{{else if (eq income_levels "30K_50K")}}\n  <p>Discover our affordable solutions designed to meet your budget.</p>\n  <div class="budget-friendly">Special savings: Check out our latest discounts and deals.</div>\n{{else if (eq income_levels "50K_74K")}}\n  <p>Explore our mid-range services that provide the best value for your money.</p>\n  <div class="value-deals">Limited-time offer: Save 15% on our top-rated services.</div>\n{{else if (eq income_levels "75K_99K")}}\n  <p>Access our high-quality services that cater to your lifestyle needs.</p>\n  <div class="high-quality">Featured service: Complimentary consultation with our experts.</div>\n{{else if (eq income_levels "GT_150K")}}\n  <p>Welcome to our elite club! Benefit from our bespoke services and products.</p>\n  <div class="elite-benefits">VIP treatment: Personalized services and exclusive benefits just for you.</div>\n{{else if (eq income_levels "LT_30K")}}\n  <p>Our cost-effective solutions are designed to help you make the most of your income.</p>\n  <div class="cost-effective">Budget tips: Learn how to save more with our expert advice.</div>\n{{else}}\n  <p>Welcome! Discover our diverse range of products and services tailored to various income levels.</p>\n  <div class="general-offers">Check out our latest offerings and find what suits you best.</div>\n{{/if}}\n',
              }),
            }),
            '\n',
            (0, s.jsx)(n.p, {

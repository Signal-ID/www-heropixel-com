/*! For license information please see main.8c35a7bd.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '2bc'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'c5d'),
                  routes: [
                    {

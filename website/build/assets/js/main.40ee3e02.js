/*! For license information please see main.40ee3e02.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'de0'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'b86'),
                  routes: [
                    {

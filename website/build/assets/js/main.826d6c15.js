  ...
  [8792],
  {
    ...
    9246: (e, t, n) => {
      ...
      const y = [
        {
          path: '/acceptable-use',
          component: b('/acceptable-use', '300'),
          exact: !0,
        },
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'dec'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '683'),
                  routes: [
                    {

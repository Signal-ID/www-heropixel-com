/*! For license information please see main.e8860b60.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', '244'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'e25'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'c63'),
                  routes: [
                    {

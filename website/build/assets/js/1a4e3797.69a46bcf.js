/*! For license information please see 1a4e3797.69a46bcf.js.LICENSE.txt */
  ...
  [2138],
  {
    ...
    3003: (e, t, r) => {
      ...
      (o.version = r(4222)),
        ...
        (o.SearchParameters = s),
        (o.RecommendParameters = i),
        (o.SearchResults = c),
        (o.RecommendResults = a),
        (e.exports = o);
    },
    7568: (e, t, r) => {
      'use strict';
      ...
      (t.prototype = {
        ...
        _buildQueries: function (e, t) {
          return this.params
            ...
            .map(function (t) {
              var r = Object.assign({}, t, {indexName: e});
      ...
      (m.PARAMETERS = Object.keys(new m())),
        ...
        (m.validate = function (e, t) {
          ...
          return e.tagFilters && r.tagRefinements && r.tagRefinements.length > 0
            ...
            : e.numericFilters &&
              ...
              c(r.numericRefinements)
            ? new Error(
                "[Numeric filters] Can't switch from the advanced to the managed API. It is probably an error, if this is really what you want, you have to first clear the numeric filters."
              )
            : c(e.numericRefinements) && r.numericFilters
            ? new Error(
        ...
        (m.prototype = {
          ...
          _clearNumericRefinements: function (e) {
            if (void 0 === e)
              return c(this.numericRefinements) ? {} : this.numericRefinements;
      ...
      e.exports = function (e) {
        return function (t, r) {
          var n = e.hierarchicalFacets[r],
            ...
            m = a(e._getHierarchicalFacetSortBy(n)),
                    ...
                    .filter(function (e) {
                      return (function (e, t, r, n, i, a) {
                        ...
                        return (
                          ...
                          0 === r.indexOf(e) ||
                          (0 === e.indexOf(t + n) && (a || 0 === e.indexOf(r)))
                        );
                      })(e[0], l.path || r, a, t, r, n);
                    });
                  l.data = s(
                    p.map(function (e) {
                      var r = e[0];
        ...
        Object.keys(R).forEach(function (t) {
          ...
          if (u) {
            ...
            m &&
              ...
              p(o.disjunctiveFacets[l], a.facets_stats, t)),
              d &&
                ((l = g[t]),
                (o.facets[l] = {
                  name: t,
            ...
            0 === s.length ||
              ...
              t.slice(y).forEach(function (t) {
                ...
                Object.keys(r).forEach(function (t) {
                  ...
                  if (-1 !== f) {
                    var l = {};
                    if (s.length > 0 && !o.persistHierarchicalRootCount) {
                      var m = s[0].split(a)[0];
            ...
            return R(
              function (e, t) {
                  ...
                  if (r)
                    return (function (e, t) {
                      var r = [],
                        n = [],
                        i = t.hide || [],
                        a = (t.order || []).reduce(function (e, t, r) {
                          return (e[t] = r), e;
                        }, {});
                      e.forEach(function (e) {
                        var t = e.path || e.name,
                          s = i.indexOf(t) > -1;
                        s || void 0 === a[t] ? s || n.push(e) : (r[a[t]] = e);
                      }),
                ...
                if (Array.isArray(a.sortBy)) {
                  var n = o(a.sortBy, g.DEFAULT_SORT);
                  return h(e, n[0], n[1]);
                }
                if ('function' == typeof a.sortBy)
                  return (function (e, t) {
                    return t.sort(e);
                  })(a.sortBy, e);
                throw new Error(
    ...
    7311: (e, t, r) => {
      ...
      function v(e, t, r, n) {
        'function' == typeof e.addAlgoliaAgent &&
          e.addAlgoliaAgent('JS Helper (' + g + ')'),
          this.setClient(e);
        var i = r || {};
        (i.index = t),
          (this.state = m.make(i)),
          (this.recommendState = new h({params: i.recommendState})),
          (this.lastResults = null),
          (this.lastRecommendResults = null),
          (this._queryId = 0),
      ...
      s(v, n),
        ...
        (v.prototype.searchOnce = function (e, t) {
          var r = e ? this.state.setQueryParameters(e) : this.state,
            n = l._getQueries(r.index, r),
            i = this;
          if (
            (this._currentNbQueries++, this.emit('searchOnce', {state: r}), !t)
          )
            return this.client.search(n).then(
              function (e) {
                return (
                  ...
                  {content: new d(r, e.results), state: r, _originalResponse: e}
                );
              },
              function (e) {
                throw (
        ...
        (v.prototype.findAnswers = function (e) {
          ...
          var n = r.getModifiedState(t),
            i = c(
              ...
              {
                params: u(l._getHitsSearchParams(n), [
                  'attributesToSnippet',
                  'hitsPerPage',
        ...
        (v.prototype.searchForFacetValues = function (e, t, r, n) {
          ...
          var c = this.state.setQueryParameters(n || {}),
            ...
            u = l.getSearchForFacetQuery(e, t, r, c);
        ...
        (v.prototype.setQuery = function (e) {
          return (
            this._change({
        ...
        (v.prototype.clearRefinements = function (e) {
          return (
            this._change({
        ...
        (v.prototype.addDisjunctiveFacetRefinement = function (e, t) {
          return (
            this._change({
        ...
        (v.prototype.addHierarchicalFacetRefinement = function (e, t) {
          return (
            this._change({
              state: this.state
                .resetPage()
        ...
        (v.prototype.addNumericRefinement = function (e, t, r) {
          return (
            this._change({
        ...
        (v.prototype.addFacetRefinement = function (e, t) {
          return (
            this._change({
        ...
        (v.prototype.addFacetExclusion = function (e, t) {
          return (
            this._change({
        ...
        (v.prototype.addFrequentlyBoughtTogether = function (e) {
          return (
        ...
        (v.prototype.addRelatedProducts = function (e) {
          return (
            this._recommendChange({
        ...
        (v.prototype.addTrendingItems = function (e) {
          return (
            this._recommendChange({
        ...
        (v.prototype.addTrendingFacets = function (e) {
          return (
            this._recommendChange({
        ...
        (v.prototype.addLookingSimilar = function (e) {
          return (
            this._recommendChange({
        ...
        (v.prototype.removeNumericRefinement = function (e, t, r) {
          return (
            this._change({
        ...
        (v.prototype.removeDisjunctiveFacetRefinement = function (e, t) {
          return (
            this._change({
              state: this.state
                .resetPage()
        ...
        (v.prototype.removeHierarchicalFacetRefinement = function (e) {
          return (
            this._change({
              state: this.state
                .resetPage()
        ...
        (v.prototype.removeFacetRefinement = function (e, t) {
          return (
            this._change({
        ...
        (v.prototype.removeFacetExclusion = function (e, t) {
          return (
            this._change({
        ...
        (v.prototype.removeTag = function (e) {
          return (
            this._change({
        ...
        (v.prototype.removeFrequentlyBoughtTogether = function (e) {
          return (
            this._recommendChange({state: this.recommendState.removeParams(e)}),
            this
          );
        }),
        (v.prototype.removeRelatedProducts = function (e) {
          return (
            this._recommendChange({state: this.recommendState.removeParams(e)}),
            this
          );
        }),
        (v.prototype.removeTrendingItems = function (e) {
          return (
            this._recommendChange({state: this.recommendState.removeParams(e)}),
            this
          );
        }),
        (v.prototype.removeTrendingFacets = function (e) {
          return (
            this._recommendChange({state: this.recommendState.removeParams(e)}),
            this
          );
        }),
        (v.prototype.removeLookingSimilar = function (e) {
          return (
            this._recommendChange({state: this.recommendState.removeParams(e)}),
            this
          );
        }),
        (v.prototype.toggleFacetExclusion = function (e, t) {
          return (
            this._change({
        ...
        (v.prototype.toggleRefinement = function (e, t) {
          return this.toggleFacetRefinement(e, t);
        }),
        (v.prototype.toggleFacetRefinement = function (e, t) {
          return (
            this._change({
        ...
        (v.prototype.toggleTag = function (e) {
          return (
            this._change({
        ...
        (v.prototype.setCurrentPage = y),
        (v.prototype.setPage = y),
        (v.prototype.setIndex = function (e) {
          return (
            this._change({
        ...
        (v.prototype.setQueryParameter = function (e, t) {
          return (
            this._change({
        ...
        (v.prototype.setState = function (e) {
          return this._change({state: m.make(e), isPageReset: !1}), this;
        }),
        (v.prototype.overrideStateWithoutTriggeringChangeEvent = function (e) {
          return (this.state = new m(e)), this;
        }),
        (v.prototype.hasRefinements = function (e) {
          return (
        ...
        (v.prototype.isExcluded = function (e, t) {
          return this.state.isExcludeRefined(e, t);
        }),
        (v.prototype.isDisjunctiveRefined = function (e, t) {
          return this.state.isDisjunctiveFacetRefined(e, t);
        }),
        (v.prototype.hasTag = function (e) {
        ...
        (v.prototype.getCurrentPage = R),
        (v.prototype.getPage = R),
        (v.prototype.getTags = function () {
          return this.state.tagRefinements;
        }),
        (v.prototype.getRefinements = function (e) {
          var t = [];
        ...
        (v.prototype.getNumericRefinement = function (e, t) {
          return this.state.getNumericRefinement(e, t);
        }),
        (v.prototype.getHierarchicalFacetBreadcrumb = function (e) {
          return this.state.getHierarchicalFacetBreadcrumb(e);
        }),
        (v.prototype._search = function (e) {
          var t = this.state,
            r = [],
            n = [];
          e.onlyWithDerivedHelpers ||
            ((n = l._getQueries(t.index, t)),
        ...
        (v.prototype._recommend = function () {
          ...
          var a = this._recommendCache,
            s = this.derivedHelpers.map(function (t) {
              var r = t.getModifiedState(e).index;
              if (!r) return [];
              var s = t.getModifiedRecommendState(new h());
              return (
                n.push({state: s, index: r, helper: t}),
                (i = Array.prototype.concat.apply(
                  i,
                  s.params.map(function (e) {
                    return e.$$id;
                  })
                )),
                t.emit('fetch', {
                  recommend: {state: s, results: t.lastRecommendResults},
                }),
                s._buildQueries(r, a)
              );
            }),
          ...
          if (0 !== c.length)
            if (c.length > 0 && void 0 === this.client.getRecommendations)
              console.warn(
              ...
              try {
                this.client
                  ...
                  .then(this._dispatchRecommendResponse.bind(this, o, n, i))
                  .catch(this._dispatchRecommendError.bind(this, o));
              } catch (u) {
                this.emit('error', {error: u});
              }
            }
        }),
        (v.prototype._dispatchAlgoliaResponse = function (e, t, r) {
          var n = this;
          if (!(t < this._lastQueryIdReceived)) {
            ...
            e.forEach(function (e) {
              var t = e.state,
                ...
                s = i.splice(0, r);
              t.index
                ? ((a.lastResults = new d(t, s, n._searchResultsOptions)),
                  a.emit('result', {results: a.lastResults, state: t}))
                : a.emit('result', {results: null, state: t});
            });
          }
        }),
        (v.prototype._dispatchRecommendResponse = function (e, t, r, n) {
            ...
            r.forEach(function (e) {
              ...
              t.forEach(function (e) {
                var t = e.state,
                  r = e.helper;
                e.index
                  ? ((r.lastRecommendResults = new f(t, s)),
        ...
        (v.prototype._dispatchAlgoliaError = function (e, t) {
        ...
        (v.prototype._dispatchRecommendError = function (e, t) {
          e < this._lastRecommendQueryIdReceived ||
            ((this._currentNbRecommendQueries -=
              e - this._lastRecommendQueryIdReceived),
            (this._lastRecommendQueryIdReceived = e),
        ...
        (v.prototype.containsRefinement = function (e, t, r, n) {
          return e || 0 !== t.length || 0 !== r.length || 0 !== n.length;
        }),
        (v.prototype._hasDisjunctiveRefinements = function (e) {
          return (
        ...
        (v.prototype._recommendChange = function (e) {
          var t = e.state;
          t !== this.recommendState &&
        ...
        (v.prototype.setClient = function (e) {
          return (
            this.client === e ||
              ('function' == typeof e.addAlgoliaAgent &&
                e.addAlgoliaAgent('JS Helper (' + g + ')'),
        ...
        (v.prototype.detachDerivedHelper = function (e) {
      ...
      var a = {
            ...
            t.getRefinedHierarchicalFacets().forEach(function (n) {
              ...
              if (s.length > 0 && s[0].split(c).length > 1) {
                ...
                o.forEach(function (n, s) {
                  var c = a._getDisjunctiveFacetSearchParams(
                    t,
                    n.attribute,
                    0 === s
                  );
        ...
        _getHitsSearchParams: function (e) {
          var t = e.facets
            ...
            o = {facets: t.indexOf('*') > -1 ? ['*'] : t, tagFilters: c};
          return (
        ...
        _getDisjunctiveFacetSearchParams: function (e, t, r) {
          ...
          return (
            (u.facets = h
              ? a._getDisjunctiveHierarchicalFacetAttribute(e, h, r)
              : t),
                ...
                if (void 0 !== a) {
                  ...
                  if (t === i) {
                    if (
                      -1 === a.indexOf(h) ||
                      (!f && !0 === r) ||
                      (f && f.split(h).length === a.split(h).length)
                    )
                      return;
                    f
                      ? ((o = f.split(h).length - 1), (a = f))
                      : ((o = a.split(h).length - 2),
                        (a = a.slice(0, a.lastIndexOf(h)))),
                      (s = u.attributes[o]);
                  } else (o = a.split(h).length - 1), (s = u.attributes[o]);
                  s && n.push([s + ':' + a]);
                }
              }),
            n
        ...
        getSearchForFacetQuery: function (e, t, r, s) {
          ...
          return (
            ...
            i(n({}, a._getHitsSearchParams(c), o))
          );
        },
      };
      e.exports = a;
                ...
                p = {
                  ...
                  onRetry: function (n) {
                    ...
                    return (
                      n.isTimedOut && l++,
                      Promise.all([
                        e.logger.info('Retryable failure', w(i)),
                        e.hostsCache.set(h, y(h, n.isTimedOut ? v : g)),
                      ]).then(function () {
                        return t(r, a);
                      })
                    );
          ...
          T = function (e) {
            return function (t, n) {
              var i = t.map(function (e) {
                return r(r({}, e), {}, {params: x(e.params || {})});
              });
              ...
              return Promise.all(
                t.map(function (t) {
                  ...
                  return N(e)(t.indexName, {
                    methods: {searchForFacetValues: I},
                  }).searchForFacetValues(s, c, r(r({}, i), o));
                })
              );
            };
          },
          ...
          var i,
            a = {
              ...
              logger:
                ...
                {
                  debug: function (e, t) {
                    return k >= i && console.debug(e, t), Promise.resolve();
                  },
                  info: function (e, t) {
                    return D >= i && console.info(e, t), Promise.resolve();
                  },
                  error: function (e, t) {
              ...
              hostsCache: c({
                caches: [s({key: ''.concat('4.23.3', '-').concat(e)}), o()],
              }),
              userAgent: j('4.23.3').add({segment: 'Browser', version: 'lite'}),
            ...
            r(
              ...
              {},
              {
                methods: {
                  ...
                  multipleQueries: T,
                  multipleSearchForFacetValues: H,
                  customRequest: A,
                  ...
                  getRecommendations: L,
                },
              }
            )
          );
        }
        return (V.version = '4.23.3'), V;
      })();
    },
    5324: (e, t, r) => {
      'use strict';
    ...
    8901: (e, t, r) => {
      ...
      const j = {
        ...
        searchVersionInput: 'searchVersionInput_m0Ui',
        searchResultsColumn: 'searchResultsColumn_JPFH',
        algoliaLogo: 'algoliaLogo_rT1R',
        algoliaLogoPathFill: 'algoliaLogoPathFill_WdUC',
        searchResultItem: 'searchResultItem_Tv2o',
        searchResultItemHeading: 'searchResultItemHeading_KbCB',
        searchResultItemPath: 'searchResultItemPath_lhe1',
        searchResultItemSummary: 'searchResultItemSummary_AEaO',
        searchQueryColumn: 'searchQueryColumn_RTkw',
        searchVersionColumn: 'searchVersionColumn_ypXd',
        searchLogoColumn: 'searchLogoColumn_rJIA',
        loadingSpinner: 'loadingSpinner_XVxU',
        'loading-spin': 'loading-spin_vzvp',
        loader: 'loader_vvXV',
      };
      var E = Object.defineProperty,
        ...
        N = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        T = (e, t) => {
          for (var r in t || (t = {})) S.call(t, r) && N(e, r, t[r]);
          if (w) for (var r of w(t)) A.call(t, r) && N(e, r, t[r]);
          return e;
        },
        H = (e, t) => x(e, O(t));
      function Q({docsSearchVersionsHelpers: e}) {
          ...
          t.map(([r, i]) => {
            ...
            return n.createElement(
              'select',
              {
                ...
                className: j.searchVersionInput,
              },
              i.versions.map((e, t) =>
      ...
      function C() {
        const {
          ...
          E = (function () {
            const e = (0, l.Gy)(),
              [t, r] = (0, n.useState)(() =>
                Object.entries(e).reduce(
                  (e, [t, r]) => H(T({}, e), {[t]: r.versions[0].name}),
                  {}
                )
              ),
            ...
            return {
              ...
              versioningEnabled: i,
              searchVersions: t,
              setSearchVersion: (e, t) => r(r => H(T({}, r), {[e]: t})),
            };
          })(),
          [x, O] = (0, d.b)(),
          w = {
          ...
          [S, A] = (0, n.useReducer)((e, t) => {
            switch (t.type) {
              case 'reset':
                return w;
              case 'loading':
                return H(T({}, e), {loading: !0});
              case 'update':
                return x !== t.value.query
                  ? e
                  : H(T({}, t.value), {
                      items:
                        0 === t.value.lastPage
            ...
            const a = e =>
              ...
              s = t.map(
                ({
                  ...
                  const n = Object.keys(t).map(e => a(t[e].value));
                  return {
                    title: n.pop(),
                    url: c(e),
                    summary: r.content ? `${a(r.content.value)}...` : '',
                    breadcrumbs: n,
                  };
                }
              );
        ...
        const [I, k] = (0, n.useState)(null),
            ...
            u.A.canUseIntersectionObserver &&
              new IntersectionObserver(
                e => {
                  ...
                  t && D.current > r && A({type: 'advance'}), (D.current = r);
                },
                {threshold: 1}
              )
          ),
          ...
          V = (0, p._q)((t = 0) => {
            C.addDisjunctiveFacetRefinement('docusaurus_tag', 'default'),
              C.addDisjunctiveFacetRefinement('language', e),
              ...
              C.setQuery(x).setPage(t).search();
          });
        return (
          (0, n.useEffect)(() => {
            if (!I) return;
            const e = q.current;
            return e ? (e.observe(I), () => e.unobserve(I)) : () => !0;
          }, [I]),
          (0, n.useEffect)(() => {
            A({type: 'reset'}),
              x &&
          ...
          }, [x, E.searchVersions, V]),
          (0, n.useEffect)(() => {
            S.lastPage && 0 !== S.lastPage && V(S.lastPage);
          }, [V, S.lastPage]),
          n.createElement(
            P.A,
            null,
            n.createElement(
              h.A,
              null,
              n.createElement('title', null, (0, v.s)(L())),
            ...
            n.createElement(
              ...
              n.createElement(_.A, {as: 'h1'}, L()),
              n.createElement(
                'form',
                {className: 'row', onSubmit: e => e.preventDefault()},
                n.createElement(
                  'div',
                  {
                    className: (0, i.A)('col', j.searchQueryColumn, {
                ...
                E.versioningEnabled &&
                  n.createElement(Q, {docsSearchVersionsHelpers: E})
              ),
              n.createElement(
                'div',
                {className: 'row'},
                n.createElement(
                  'div',
                  {className: (0, i.A)('col', 'col--8', j.searchResultsColumn)},
                  !!S.totalResults && g(S.totalResults)
                ),
                n.createElement(
                  'div',
                  {
                  ...
                  n.createElement(
                    ...
                    n.createElement(
                      'svg',
                      {viewBox: '0 0 168 24', className: j.algoliaLogo},
                      n.createElement(
                        'g',
                        {fill: 'none'},
                        n.createElement('path', {
                          className: j.algoliaLogoPathFill,
              ...
              S.items.length > 0
                ? n.createElement(
                    ...
                    null,
                    S.items.map(
                      ({title: e, url: t, summary: r, breadcrumbs: a}, s) =>
                        n.createElement(
                          'article',
                          {key: s, className: j.searchResultItem},
                          n.createElement(
                            _.A,
                            {as: 'h2', className: j.searchResultItemHeading},
                            n.createElement(f.A, {
                              to: t,
                          ...
                          r &&
                            n.createElement('p', {
                              className: j.searchResultItemSummary,
                ...
                : [
                    ...
                    !!S.loading &&
                      n.createElement('div', {
                        key: 'spinner',
                        className: j.loadingSpinner,
                      }),
                  ],
              S.hasMore &&
                n.createElement(
                  'div',
                  {className: j.loader, ref: k},
                  n.createElement(
                    y.A,
                    {

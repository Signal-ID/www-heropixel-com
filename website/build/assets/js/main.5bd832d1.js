/*! For license information please see main.5bd832d1.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '49a'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'b97'),
                  routes: [
                    {

/*! For license information please see main.57285433.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', '244'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '84a'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'd14'),
                  routes: [
                    {

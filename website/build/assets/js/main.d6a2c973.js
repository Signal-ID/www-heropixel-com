/*! For license information please see main.d6a2c973.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'afd'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '9c7'),
                  routes: [
                    {

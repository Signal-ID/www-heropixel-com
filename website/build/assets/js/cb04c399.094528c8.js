/*! For license information please see cb04c399.094528c8.js.LICENSE.txt */
'use strict';
    ...
    931: (e, n, t) => {
      ...
      const r = {id: 's3-glue', title: 'S3 Glue', description: 's3-glue'},
        ...
        c = {
          ...
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/s3-glue.md',
          tags: [],
          version: '0.0.1',
          frontMatter: {
            id: 's3-glue',
        ...
        o = [
          ...
          {value: 'Step 2: Set up Glue', id: 'step-2-set-up-glue', level: 2},
          {
            ...
            id: 'step-3-set-up-the-s3-glue-destination-connector-in-hero-pixel',
            level: 2,
          },
          ...
          children: [
            ...
            (0, s.jsxs)(n.ol, {
              children: [
                ...
                (0, s.jsx)(n.li, {
                  children:
                    'Allow permissions to access the AWS Glue service from the Hero Pixel connector',
                }),
                '\n',
              ],
            }),

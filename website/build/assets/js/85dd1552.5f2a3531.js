/*! For license information please see 85dd1552.5f2a3531.js.LICENSE.txt */
'use strict';
    ...
    8019: (e, n, t) => {
      ...
      const r = {id: 'event-pageview', title: 'Pageview', description: 'desc'},
        ...
        l = {
          ...
          title: 'Pageview',
          description: 'desc',
          source: '@site/../docs/event-pageview.md',
          sourceDirName: '.',
          slug: '/event-pageview',
          permalink: '/docs/next/event-pageview',
          draft: !1,
          unlisted: !1,
          editUrl:
            'https://github.com/facebook/react-native-website/blob/main/website/../docs/event-pageview.md',
          tags: [],
          version: 'current',

/*! For license information please see main.932d4603.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', '244'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '442'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', '5ed'),
                  routes: [
                    {

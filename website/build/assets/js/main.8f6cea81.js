/*! For license information please see main.8f6cea81.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', 'cce'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', '174'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'a06'),
                  routes: [
                    {
                    ...
                    },
                    {
                      ...
                      component: b('/docs/dont-install-with-gtm', 'c2b'),
                      exact: !0,
                      sidebar: 'docs',
                    },
                    {

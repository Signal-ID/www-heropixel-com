/*! For license information please see main.218b1900.js.LICENSE.txt */
      ...
      const y = [
        ...
        {path: '/versions', component: b('/versions', '244'), exact: !0},
        {
          ...
          routes: [
            ...
            {
              path: '/docs',
              component: b('/docs', 'd78'),
              routes: [
                {
                  path: '/docs',
                  component: b('/docs', 'd2a'),
                  routes: [
                    {
                    ...
                    },
                    {
                      ...
                      component: b('/docs/start-get-your-leads', '8f6'),
                      exact: !0,
                      sidebar: 'docs',
                    },
                    {

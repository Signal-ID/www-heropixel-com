  ...
  [3940, 5238, 8295, 298],
  {
    1867: (e, t, a) => {
      ...
      var n = a(3696),
        ...
        c = a(2946),
        l = a(4869);
      const s = 'flyoutIllustration_Bvcw';
      const i = function () {
        return n.createElement(
          ...
          n.createElement(c.default, {
            ...
            description: n.createElement(
              ...
              n.createElement('code', null, 'View'),
              ',',
              ' ',
              n.createElement('code', null, 'Text'),
              ', and ',
              n.createElement('code', null, 'Image'),
    ...
    2946: (e, t, a) => {
      ...
      const s = function ({title: e, description: t}) {
        return n.createElement(
          ...
          n.createElement('h3', {className: l}, t)
        );
      };
    },
    4869: (e, t, a) => {
      ...
      var n = a(3696);
      const r = function ({lightSrc: e, darkSrc: t, className: a, alt: r}) {
        const [c, l] = (0, n.useState)('light');
        return (
          (0, n.useEffect)(() => {
            const e = new MutationObserver(e => {
                e.forEach(e => {
                  'attributes' === e.type &&
                    ...
                    l(e.target.getAttribute('data-theme'));
                });
              }),

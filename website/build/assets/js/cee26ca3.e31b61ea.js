/*! For license information please see cee26ca3.e31b61ea.js.LICENSE.txt */
'use strict';
    ...
    1717: (e, t, n) => {
      ...
      const d = {id: 'weaviate', title: 'weaviate', description: 'weaviate'},
        ...
        a = {
          ...
          unlisted: !1,
          editUrl:
            'https://github.com/Signal-ID/www-heropixel-com/blob/main/website/../docs/destinations/weaviate.md',
          tags: [],
          version: '0.0.1',
          frontMatter: {
            id: 'weaviate',
              ...
              children: [
                ...
                (0, i.jsxs)(t.li, {
                  children: [
                    ...
                    ' - The URL of the Weaviate cluster to load data into. Hero Pixel Cloud only supports connecting to your Weaviate Instance instance with TLS encryption.',
                  ],
                }),
                '\n',
                (0, i.jsxs)(t.li, {
